...
const PAIRS = [
  ...
  ['--fg', '--bg-panel', 4.5, 'body text on a card'],
  ['--fg', '--bg-sunk', 4.5, 'body text on a recessed surface'],
  ['--fg', '--bg-raised', 4.5, 'body text on a raised surface'],
  ['--fg-muted', '--bg', 4.5, 'secondary text on page'],
  ['--fg-muted', '--bg-panel', 4.5, 'secondary text on a card'],
  ['--fg-muted', '--bg-sunk', 4.5, 'secondary text on a recessed surface'],
  ['--fg-faint', '--bg-panel', 3, 'tertiary text on a card'],
  ['--accent-fg', '--accent-solid', 4.5, 'text on a filled button'],
  ['--flag-fg', '--flag', 4.5, 'text on the focus flag'],
  ['--accent', '--bg', 3, 'accent against page'],
  ['--accent', '--bg-panel', 3, 'accent against a card'],
  ['--accent', '--accent-wash', 3, 'accent on its own wash'],
  ['--ok', '--bg-panel', 3, 'ok state'],
  ['--warn', '--bg-panel', 3, 'warning state'],
  ['--danger', '--bg-panel', 3, 'danger state'],
  ['--ok', '--ok-wash', 3, 'ok on its own wash'],
  ['--warn', '--warn-wash', 3, 'warning on its own wash'],
  ['--danger', '--danger-wash', 3, 'danger on its own wash'],
  ['--line-strong', '--bg', 3, 'strong rules and borders'],
  ['--flag', '--bg', 3, 'focus ring against page'],
  ['--flag', '--bg-panel', 3, 'focus ring against a card'],
  ['--topbar-fg', '--topbar-bg', 4.5, 'top bar text'],
  ['--topbar-muted', '--topbar-bg', 4.5, 'top bar secondary text'],
];
